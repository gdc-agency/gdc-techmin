...
const Typography = () => {
  return <>
      ...
      <Row>
        <Col xs={12}>
          <ComponentContainerCard title="Display headings" description={<p className="text-muted mb-0">
      ...
      <Row>
        <Col xs={12}>
          <ComponentContainerCard title="Headings" description={<p className="text-muted mb-0">
      ...
      <Row>
        <Col xl={12}>
          <ComponentContainerCard title="Inline text elements" description={<p className="text-muted mb-0">Styling for common inline HTML5 elements.</p>}>
      ...
      <Row>
        <Col xl={4}>
          <ComponentContainerCard title="Unordered" description={<p className="text-muted mb-0">A list of items in which the order does not explicitly matter.</p>}>
            <ul>
        ...
        <Col xl={4}>
          <ComponentContainerCard title="Ordered" description={<p className="text-muted mb-0">A list of items in which the order does explicitly matter.</p>}>
            <ol>
              <li>Lorem ipsum dolor sit amet</li>
              <li>Consectetur adipiscing elit</li>
              <li>Integer molestie lorem at massa</li>
        ...
        <Col xl={4}>
          <ComponentContainerCard title="Unstyled" description={<p className="text-muted mb-0">
      ...
      <Row>
        <Col xl={12}>
          <ComponentContainerCard title="Blockquotes" description={<p className="text-muted mb-0">
        ...
        <Col xl={12}>
          <ComponentContainerCard title="Description list alignment" description={<p className="text-muted mb-0">
