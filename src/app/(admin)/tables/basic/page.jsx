...
const InverseTable = () => {
  return <ComponentContainerCard title="Inverse table" description={<p className="text-muted mb-0">
...
const StripedRows = () => {
  return <ComponentContainerCard title="Striped rows" description={<p className="text-muted mb-0">
...
const TableHeadOptions = () => {
  return <ComponentContainerCard title="Table head options" description={<p className="text-muted mb-0">
...
const HoverableRows = () => {
  return <ComponentContainerCard title="Hoverable rows" description={<p className="text-muted mb-0">
...
const SmallTable = () => {
  return <ComponentContainerCard title="Small table" description={<p className="text-muted mb-0">
...
const BorderedTable = () => {
  return <ComponentContainerCard title="Bordered table" description={<p className="text-muted mb-0">
...
const BorderedColorTable = () => {
  return <ComponentContainerCard title="Bordered color table" description={<p className="text-muted mb-0">
...
const ResponsiveTable = () => {
  return <ComponentContainerCard title="Always responsive" description={<p className="text-muted mb-0">
...
const BorderlessTable = () => {
  return <ComponentContainerCard title="Basic Borderless Example" description={<p className="text-muted mb-0">
...
const BorderlessInverseTable = () => {
  return <ComponentContainerCard title="Inverse Borderless table" description={<p className="text-muted mb-0">
          Add <code>.table-borderless</code> for a table without borders.
        </p>}>
      <div className="table-responsive-sm">
...
const ActiveTable = () => {
  return <>
      <ComponentContainerCard title=" Active tables" description={<p className="text-muted mb-0">
...
const NestedTable = () => {
  return <ComponentContainerCard title="Nesting" description={<p className="text-muted mb-0">Border styles, active styles, and table variants are not inherited by nested tables.</p>}>
      <div className="table-responsive-sm">
