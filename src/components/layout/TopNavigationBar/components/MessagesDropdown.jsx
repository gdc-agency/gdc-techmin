...
const MessagesDropdown = ({
  ...
  return <Dropdown as="li" className="notification-list">
      ...
      <DropdownMenu className="dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
        ...
        maxHeight: 300
          ...
          {messages.map((message, idx) => <DropdownItem className="p-0 notify-item read-noti card m-0 shadow-none" key={idx}>
              <CardBody>
